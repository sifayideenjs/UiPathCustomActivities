...
{
    public class SftpDeleteFile : CodeActivity
    {
        [Category("Input")]
        [RequiredArgument]
        ...
        [Category("Input")]
        [RequiredArgument]
        public InArgument<string> RemoteFilePathToDelete { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            if (sftp != null)
            {
                if (sftp.IsConnected)
                {
                    try
                    {
                        string pathRemoteFileToDelete = this.RemoteFilePathToDelete.Get(context);
